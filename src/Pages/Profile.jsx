                ...
                <div className="card-header">
                  <ul className="nav nav-tabs-custom rounded card-header-tabs border-bottom-0"
                    ...
                    <li className="nav-item">
                      <Link className="nav-link active" data-bs-toggle="tab" to="#personalDetails"
                        role="tab">
                        Personal Details
                      </Link>
                    </li>
                    ...
                    <li className="nav-item">
                      <Link className="nav-link" data-bs-toggle="tab" to="#experience" role="tab">
                        Experience
                      </Link>
                    </li>
                    <li className="nav-item">
                      <Link className="nav-link" data-bs-toggle="tab" to="#privacy" role="tab">
                        Privacy Policy
                      </Link>
                    </li>
                  </ul>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-12">
                            <div className="mb-3">
                              ...
                              <select className="form-control" name="skillsInput" data-choices
                        ...
                        <div className="row g-2">
                          ...
                          <div className="col-lg-12">
                            <div className="text-end">
                              <button type="submit" className="btn btn-info">Change
                                Password</button>
                            </div>
                          </div>
                      ...
                      <form>
                            ...
                            <div className="row">
                              ...
                              <div className="hstack gap-2 justify-content-end">
                                <Link className="btn btn-info"
                                  to="javascript:deleteEl(1)">Delete</Link>
                              </div>
                            </div>
                        ...
                        <div className="col-lg-12">
                          <div className="hstack gap-2">
                            ...
                            <Link to="javascript:new_link()" className="btn btn-primary">Add
                              New</Link>
                          </div>
                        </div>
                    ...
                    <div className="tab-pane" id="privacy" role="tabpanel">
                      ...
                      <div>
                        ...
                        <div className="hstack gap-2 mt-3">
                          <Link to="#" className="btn btn-soft-info">Close &
